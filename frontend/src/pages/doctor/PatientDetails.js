      ...
      >
        <div className="d-flex gap-2">
          <Link
            ...
            to={`/doctor/patients/${id}/add-visit`}
          >
          ...
          <GlassCard className="p-4 mb-4">
            ...
            <div className="health-conditions">
              <div className="condition-item">
                ...
                <span
                  className={`badge ${patient?.hypertension ? "bg-danger" : "bg-success"}`}
                >
              ...
              <div className="condition-item">
                ...
                <span
                  className={`badge ${patient?.heartDisease ? "bg-danger" : "bg-success"}`}
                >
              ...
              <div className="condition-item">
                ...
                <span className="value text-capitalize">
                  {patient?.smokingHistory || "Not specified"}
                </span>
              </div>
            </div>
          </GlassCard>
                  ...
                  {visits.length === 0 ? (
                    <div className="text-center py-5">
                      ...
                      <p className="text-muted small">
                        Schedule the patient's first visit to start tracking
                          ...
                          >
                            <div className="visit-header">
                              ...
                              {visit.prediction?.riskLabel && (
                                <span
                                  className={`badge bg-${getRiskBadge(visit.prediction.riskLabel)}`}
                                >
                            ...
                            <div className="visit-metrics">
                              ...
                              {visit.metrics?.bloodGlucoseLevel && (
                                <span className="metric">
                                  Glucose: {visit.metrics.bloodGlucoseLevel}{" "}
                                  mg/dL
                                </span>
                              )}
                              {visit.metrics?.bmi && (
                ...
                >
                  ...
                  {visits.length === 0 ? (
                    <div className="text-center py-5">
                      ...
                      <p className="text-muted small">
                        Charts will appear once visits with metrics are recorded
                      </p>
                    </div>
                  ) : (

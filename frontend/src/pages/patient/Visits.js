        ...
        {visits && visits.length === 0 ? (
          <GlassCard className="p-5 text-center">
            ...
            <p className="text-muted mb-0">
              Your health journey starts with your first doctor visit
            </p>
          </GlassCard>
        ) : (
                    ...
                    >
                      ...
                      <div className="timeline-toggle">
                        <motion.i
                          ...
                          animate={{
                            rotate: expandedVisit === visit._id ? 180 : 0,
                          }}
                          ...
                          <div className="row g-3">
                            <div className="col-md-6">
                              <h6 className="text-muted mb-2">
                                <i className="fas fa-vial me-2"></i>Health
                                Metrics
                              </h6>
                              <div className="metrics-grid">
                                ...
                                {visit.metrics?.bloodGlucoseLevel && (
                                  <div className="metric-item">
                                    ...
                                    <span className="value">
                                      {visit.metrics.bloodGlucoseLevel} mg/dL
                                    </span>
                                  </div>
                                )}
                                {visit.metrics?.bmi && (
                            ...
                            <div className="col-md-6">
                              <h6 className="text-muted mb-2">
                                <i className="fas fa-user-md me-2"></i>Doctor's
                                Assessment
                              </h6>
                              {visit.prediction && (
                                <div className="mb-3">
                                  ...
                                  {visit.prediction.riskScore && (
                                    <div className="small text-muted">
                                      Risk Score:{" "}
                                      {visit.prediction.riskScore.toFixed(2)}
                                    </div>
                                  )}
                                </div>
                              )}

            ...
            {latestVisit ? (
              <div>
                ...
                <div className="mb-3">
                  ...
                  <p className="small mb-0">
                    {latestVisit.notes || "No notes available"}
                  </p>
                </div>
                <div className="mb-3">
                  <small className="text-muted">Recommendations</small>
                  <p className="small mb-0">
                    {latestVisit.recommendations || "No recommendations"}
                  </p>
                </div>
                <Link
                  to="/patient/visits"
              ...
              <div className="text-center py-4">
                ...
                <p className="small text-muted">
                  Schedule your first appointment with your doctor
                </p>
              </div>
            )}
          </GlassCard>
            ...
            {visits.length > 1 ? (
              <HbA1cChart
                data={{
                  labels: visits
                    .slice()
                    .reverse()
                    .map((v) => new Date(v.visitDate).toLocaleDateString()),
                  values: visits
                    .slice()
                    .reverse()
                    .map((v) => v.metrics?.HbA1cLevel || 0),
                }}
              />
            ) : (
              <div className="text-center py-5">
                ...
                <small className="text-muted">
                  Complete additional visits to see your progress
                </small>
              </div>
            )}
          </GlassCard>
